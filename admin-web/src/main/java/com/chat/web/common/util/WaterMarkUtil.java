...
//        new waterMarkUtil().addWatermark("D:/picture/营业执照二.jpg", "D:/picture/营业执照二222.jpg", "仅限追溯查询展示使用", "jpg", Color.gray);
     ...
     * @return void
     */
   /* public void addWatermark(String sourceImgPath, String tarImgPath, String waterMarkContent,String fileExt,Color markContentColor){
        Font font = new Font("宋体", Font.BOLD, 70);//水印字体，大小
        Integer degree = -45;//设置水印文字的旋转角度
        float alpha = 0.3f;//设置水印透明度 默认为1.0  值越小颜色越浅
     ...
     * @return void
     */
    public static void addWatermark(MultipartFile file, String tarImgPath, String waterMarkContent, String fileExt, Color markContentColor){
        Font font = new Font("宋体", Font.BOLD, 70);//水印字体，大小
        Integer degree = -45;//设置水印文字的旋转角度
        float alpha = 0.3f;//设置水印透明度 默认为1.0  值越小颜色越浅
        OutputStream outImgStream = null;
